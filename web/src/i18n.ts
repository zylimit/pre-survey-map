...
const en = {
  ...
  "log.delete_site_ok":    "Deleted {n} site(s) · restore point #{rp} (rollbackable)",
  ...
  "lfl.del.body":                "About to delete {n} site(s). This can be rolled back from restore points. Continue?",
...
const zh: Record<keyof typeof en, string> = {
  ...
  "log.delete_site_ok":    "已删除 {n} 个站点 · 恢复点 #{rp}（可回滚）",
  ...
  "lfl.del.cancel":              "取消",
  "lfl.del.title":               "删除站点",
  "lfl.del.body":                "将删除 {n} 个站点，可在恢复点回滚。确认删除？",
  "lfl.exp.btn":                 "导出选中",
  "lfl.edit.title":              "编辑站点",
  "lfl.edit.save":               "保存",
  "lfl.edit.saving":             "保存中...",
