...
const en = {
  ...
  "tb.export.tip":         "Export KMZ (all / selection)",
  "tb.draw.label":         "⬛ Selection ▾",
  "tb.draw.tip":           "Draw a selection area (polygon / rectangle / circle)",
  ...
  "tb.polygon_labels.label": "🏷 Labels",
  "tb.polygon_labels.tip":   "Toggle area / lessor name labels",
  "tb.operator_letters.label": "Operator letters",
  "tb.operator_letters.tip":   "Toggle site operator letters (G / S / D)",
  ...
  "lt.tree.status.undetermined":  "Undetermined",
  ...
  // #51 area 只读列表列（name 去重键 + extras 主要字段）
  "lfl.col.name":                "Name",
  "lfl.col.polygon_id":          "Polygon ID",
  "lfl.col.geozone_pr":          "Geozone PR",
  "lfl.col.new_polygo":          "New Polygo",
  // #48 site 增删改 + 勾选导出
...
const zh: Record<keyof typeof en, string> = {
  ...
  "tb.export.tip":         "导出 KMZ（整库 / 选区）",
  "tb.draw.label":         "⬛ 框选 ▾",
  "tb.draw.tip":           "绘制选区（多边形 / 矩形 / 圆形）",
  ...
  "tb.polygon_labels.label": "🏷 面名称",
  "tb.polygon_labels.tip":   "显隐 区域/租户 面名称标签",
  "tb.operator_letters.label": "运营商字母",
  "tb.operator_letters.tip":   "显隐 站点运营商字母（G / S / D）",
  ...
  "lt.tree.status.undetermined":  "未确定",
